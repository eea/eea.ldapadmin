...
class RolesEditor(Folder):
            ...
            if action == 'remove-owners':
                for owner in user_id_list:
                    try:
                        ...
                        t, msg = 'info', 'Successfully removed owner %r from roles %r' % (owner, updated)
                ...
                if search_name:
                    ...
                    options.update({'search_name': search_name,
                        'results': results,
                        'inactive_users': len(found_users) != len(active_users)})
                else:
                ...
                for owner in user_id_list:
                    try:
                        ...
                        t, msg = 'info', 'Successfully added owner %r for roles %r' % (owner, updated)
    ...
    def all_members(self, REQUEST):
        ...
        users_in_role = role_members(agent, role_id, True, filter_date)['users']
